ALTER TABLE "AgentSession" ADD COLUMN IF NOT EXISTS "promptId" text;--> statement-breakpoint
ALTER TABLE "AgentSession" ADD COLUMN IF NOT EXISTS "promptVersion" text;--> statement-breakpoint
ALTER TABLE "AgentSession" ADD COLUMN IF NOT EXISTS "totalTokens" integer DEFAULT 0 NOT NULL;--> statement-breakpoint
