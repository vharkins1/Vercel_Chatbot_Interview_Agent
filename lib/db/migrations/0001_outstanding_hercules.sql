...
CREATE TABLE IF NOT EXISTS "StudySession" (
	...
	"currentTopicIndex" integer DEFAULT 0 NOT NULL,
	"currentQuestionIndex" integer DEFAULT 0 NOT NULL,
	"phase" varchar DEFAULT 'welcome' NOT NULL,
	"surveyData" json,
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "StudySession" ADD CONSTRAINT "StudySession_chatId_Chat_id_fk" FOREIGN KEY ("chatId") REFERENCES "public"."Chat"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "StudySession" ADD CONSTRAINT "StudySession_userId_User_id_fk" FOREIGN KEY ("userId") REFERENCES "public"."User"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
