CREATE TABLE IF NOT EXISTS "ChatQuestion" (
	...
	CONSTRAINT "ChatQuestion_chatId_questionId_pk" PRIMARY KEY("chatId","questionId")
);
...
CREATE TABLE IF NOT EXISTS "Invitation" (
	...
	"redeemedByChatId" uuid,
	"redeemedByExternalId" text,
	"batchLabel" text
);
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "AgentSession" ADD COLUMN "condition" text;--> statement-breakpoint
DO $$ BEGIN
...
CREATE INDEX IF NOT EXISTS "ChatQuestion_topicId_idx" ON "ChatQuestion" USING btree ("topicId");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "Invitation_batchLabel_idx" ON "Invitation" USING btree ("batchLabel");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "Invitation_redeemedByChatId_idx" ON "Invitation" USING btree ("redeemedByChatId");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "Question_topicId_idx" ON "Question" USING btree ("topicId");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "Question_topicId_text_uq" ON "Question" USING btree ("topicId","text");